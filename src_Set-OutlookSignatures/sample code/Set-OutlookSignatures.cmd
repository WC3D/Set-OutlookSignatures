...
REM For a completely hidden method, read FAQ 'Start Set-OutlookSignatures in hidden/invisible mode' (https://set-outlooksignatures.com/faq#start-set-outlooksignatures-in-hiddeninvisible-mode)
REM 
